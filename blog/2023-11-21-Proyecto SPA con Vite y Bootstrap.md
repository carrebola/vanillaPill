...
Vamos a crear una infraestructura básica para la creación de una SPA utilizando `Vite`. 
También crearemos un repositorio en `Github` y desplegaremos la app en `Github Pages`.
