...
- Copiar y pegar desde proyectosVista a adminVista
- Modificamos html y js para adaptar la vista proyectos
    ...
    <div class="col-12">
      ...
      <ul class="nav nav-tabs">
        ...
        <li id="pestanyaUsuarios" class="nav-item w-50">
          <button 
            class="selectorFicha fichaUsuarios nav-link w-100"
          >
            Usuarios
          </button>
        </li>
...
- creamos funciones pintaUsuarios
- 